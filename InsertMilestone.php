...
$sql = "INSERT INTO DevMilestones (projectID,name,description,assignee,startDate,deployedDate,priority,version,status,notes)
        VALUES('$projectid','$name','$desc','$owner','$start','$end','$priority','$ver','$status','$notes')";
