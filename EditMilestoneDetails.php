...
<table id='table2' border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#123456">
  <tr valign="bottom">
	...
	<td width="25%" align="right">
	  <?php echo "Edit Milestone Details &nbsp;&nbsp;|&nbsp;&nbsp;";?>
	  <font color="#707070">
...
$sql=("SELECT * FROM DevMilestones where milestoneID='".$msID."'");
if($results=mysqli_query($link,$sql))
{
	...
	$enddate=convertFromSQLDate($row["deployedDate"]);
	$ver=$row["version"];
...
echo "<form action=\"UpdateDevMilestoneDetails.php\" method=\"post\">";
echo "<table id='table1' cellspacing='0'>";

	echo "<tr class='even'>";
	echo "<td>Milestone Name:</td> <td><input type=\"text\" name=\"name\" value=\"".$name."\"></td>";
        echo "</tr>";
	echo "<td>Description:</td> <td><input type=\"text\" name=\"description\" value=\"".$descrip."\"></td>";
        echo "</tr>";
	echo "<td>Assignee:</td> <td><input type=\"text\" name=\"assignee\" value=\"".$assignedTo."\"></td>";
	echo "</tr>";
	echo "<tr class='even'>";
	echo "<td>Start Date (MM/DD/YYYY):</td>	<td><input type=\"text\" name=\"startdate\" value='".$startdate."'></td>";
	echo "</tr>";
	echo "<tr class='even'>";
	echo "<td>Deployed Date   (MM/DD/YYYY):</td>	<td><input type=\"text\" name=\"enddate\"  value='".$enddate."'></td>";
	echo "</tr>";
	echo "<td>Priority:</td> <td><input type=\"text\" name=\"priority\" value=\"".$priority."\"></td>";
        echo "</tr>";
	echo "<td>Version:</td> <td><input type=\"text\" name=\"version\" value=\"".$ver."\"></td>";
        echo "</tr>";
